    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pricing_method', models.CharField(choices=[('SIMPLE', 'Simple Price'), ('TIERED', 'Tiered by Quantity')], default='SIMPLE', max_length=10)),
                ('calculation_method', models.CharField(choices=[('PER_SHEET_SINGLE', 'Per Sheet (Single Side)'), ('PER_SHEET_DOUBLE', 'Per Sheet (Double Side)'), ('PER_ITEM', 'Per Final Item'), ('PER_SQ_METER', 'Per Square Meter')], max_length=20)),
                ('simple_price', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='KES', max_length=10)),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tiered_prices', to='pricing.finishingservice')),
            ],
            options={
